package com.7appdev.planeteercore.configurations.glacio;
...
public class GlacioOreGenerationCommon {
    ...
    static {
        BUILDER.push("Planeteer Core - Glacio Ore Config");

        //Glacio Lead Ores
        BUILDER.push("Planeteer Core - Glacio Lead Ore Config");
        ...
        //Glacio Tin Ores
        BUILDER.push("Planeteer Core - Glacio Tin Ore Config");
        ...
        //Glacio Uranium Ores
        BUILDER.push("Planeteer Core - Glacio Uranium Ore Config");
        ...
        //Glacio Zinc Ores
        BUILDER.push("Planeteer Core - Glacio Zinc Ore Config");
        ...
        //Glacio Cobalt Ores
        BUILDER.push("Planeteer Core - Glacio Cobalt Ore Config");
