package com.7appdev.planeteercore.configurations.mercury;
...
public class MercuryOreGenerationCommon {
    ...
    static {
        BUILDER.push("Planeteer Core - Mercury Ore Config");

        //Mercury Copper Ores
        BUILDER.push("Planeteer Core - Mercury Copper Ore Config");
        ...
        //Mercury Lead Ores
        BUILDER.push("Planeteer Core - Mercury Lead Ore Config");
        ...
        //Mercury Tin Ores
        BUILDER.push("Planeteer Core - Mercury Tin Ore Config");
        ...
        BUILDER.push("Planeteer Core - Mercury Uranium Ore Config");
        ...
        //Mercury Zinc Ores
        BUILDER.push("Planeteer Core - Mercury Zinc Ore Config");
        ...
        //Mercury Cobalt Ores
        BUILDER.push("Planeteer Core - Mercury Cobalt Ore Config");
        ...
        //Mercury Coal Ores
        BUILDER.push("Planeteer Core - Mercury Coal Ore Config");
