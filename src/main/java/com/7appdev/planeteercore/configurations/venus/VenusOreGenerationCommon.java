package com.7appdev.planeteercore.configurations.venus;
...
public class VenusOreGenerationCommon {
    ...
    static {
        BUILDER.push("Planeteer Core - Venus Ore Config");

        //Venus Copper Ores
        BUILDER.push("Planeteer Core - Venus Copper Ore Config");
        ...
        //Venus Lead Ores
        BUILDER.push("Planeteer Core - Venus Lead Ore Config");
        ...
        //Venus Tin Ores
        BUILDER.push("Planeteer Core - Venus Tin Ore Config");
        ...
        //Venus Uranium Ores
        BUILDER.push("Planeteer Core - Venus Uranium Ore Config");
        ...
        //Venus Zinc Ores
        BUILDER.push("Planeteer Core - Venus Zinc Ore Config");
        ...
        //Venus Cobalt Ores
        BUILDER.push("Planeteer Core - Venus Cobalt Ore Config");
