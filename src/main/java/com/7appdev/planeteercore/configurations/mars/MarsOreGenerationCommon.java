package com.7appdev.planeteercore.configurations.mars;
...
public class MarsOreGenerationCommon {
    ...
    static {
        BUILDER.push("Planeteer Core - Mars Ore Config");

        //Mars Copper Ores
        BUILDER.push("Planeteer Core - Mars Copper Ore Config");
        ...
        //Mars Lead Ores
        BUILDER.push("Planeteer Core - Mars Lead Ore Config");
        ...
        //Mars Tin Ores
        BUILDER.push("Planeteer Core - Mars Tin Ore Config");
        ...
        //Mars Uranium Ores
        BUILDER.push("Planeteer Core - Mars Uranium Ore Config");
        ...
        //Mars Zinc Ores
        BUILDER.push("Planeteer Core - Mars Zinc Ore Config");
        ...
        //Mars Cobalt Ores
        BUILDER.push("Planeteer Core - Mars Cobalt Ore Config");
        ...
        //Mars Coal Ores
        BUILDER.push("Planeteer Core - Mars Coal Ore Config");
